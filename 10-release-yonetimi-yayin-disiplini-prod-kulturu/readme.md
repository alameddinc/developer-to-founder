...
Bu haftanın amacı CI/CD pipeline'ı tekrar kurmak değil (onu 7. haftada yaptık).
Amaç; **Prod ortamına kod göndermeyi, korkulan bir "olay" olmaktan çıkarıp, sıkıcı bir "alışkanlık" haline getirmektir.**
...
**Neden Önemli?**
Kodu Pazartesi günü deploy edebilirsin ama özelliği Çarşamba günü marketing kampanyasıyla "Release" edebilirsin.
...
Founder'ların korkulu rüyası: *"Ya site çökerse?"*
Bu korku yüzünden haftalarca deploy yapmazlar. Biriken kod büyür, risk artar.

### Kural 1: Küçük ve Sık Deploy
1000 satırlık kodu tek seferde atmak Rus Ruletidir.
10 satırlık kodu günde 10 kere atmak ise güvenlidir. Hata çıkarsa nerede olduğunu hemen bilirsin.
...
Kullanıcılar (veya 6 ay sonraki sen) neyin değiştiğini bilmek ister. GitHub Release veya basit bir `CHANGELOG.md` dosyası tut.
**Şablon:**
```
## v1.0.2 (2025-10-24)
### ✨ Yenilikler
