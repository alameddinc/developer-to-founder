...
{% embed url="https://open.spotify.com/episode/4FCUXue0vX1ARiUG0JsWSM?si=k6jkQFiBShmg9MG-47AE0g" %}
...
> _"Çok kullanıcımız vardı ama faturaları ödeyemedik."_
...
**Basit Formül:** `Kar = (Müşteri Başına Gelir) - (Müşteri Başına Maliyet)`
...
Eğer sen bu işlemi kullanıcıya **$0.50'ye satarsan**, her satışta **$0.10 zarar edersin.** _"Sürümden kazanırız"_ dersen, çok satarsan çok batarsın.
...
**Yanlış Bakış:** "Ben bu kodu yazmak için 100 saat harcadım, o yüzden pahalı olmalı." (Kullanıcının umurunda değil.)

**Doğru Bakış (Value-Based Pricing):** "Bu yazılım senin 5 saatini kurtarıyor. Senin saatin $50 ise, ben sana $250 kazandırıyorum. O zaman bu ürün $30 eder."
...
* _Örnek: "Benim ürünüm Usage-Based olacak çünkü kullanıcılar sadece proje bazlı ihtiyaç duyuyor."_
...
* **Plan C:** (Ajans/Pro - toplu alım vs.) Her birine bir fiyat etiketi yapıştır.
...
_Developer to Founder - Week 03_
