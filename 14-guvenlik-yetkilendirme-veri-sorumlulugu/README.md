...
Bu haftanın amacı, Pentagon'u koruyacak bir sistem kurmak değildir. (Zaten kuramazsın). Amacımız; **"Kapıyı açık bırakmamaktır."**
...
Kullanıcı giriş yapmıştır (AuthN tamamdır). URL şöyledir: `app.com/invoice/123` Kullanıcı URL'i `app.com/invoice/124` yapar. **Eğer kodu şöyle yazdıysan Hacklendin:**
