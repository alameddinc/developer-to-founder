...
{% embed url="https://open.spotify.com/episode/39yTNK4NFLCFTMAUNuw6Ah?si=HN_tl2U-Qn-o9rBIoOos6w" %}

Bu haftanın amacı; ürünü sadece kodlamak değil, onu canlı tutmak, güvenli bir şekilde güncellemektir. Cloud dünyasında kaybolmak çok kolaydır. Amacımız AWS sertifikası almak değil, ürünü en az baş ağrısıyla yayına almaktır.
...
Lock-in, AWS kullanmak değil; AWS'nin **içine gömülmektir.** Kodunu öyle yaz ki, sağlayıcıyı değiştirmek bir "rewrite" değil, bir "config değişikliği" olsun.
...
_Neden? Çünkü video işleme işi "burst" (patlamalı) bir iştir. Sunucu kiralarsak %90 boş yatacak. Serverless burada maliyeti %80 düşürdü._
...
> _"Ben \[MODEL]'i seçtim çünkü şu an \[HIZ/MALİYET] benim için daha önemli."_
...
_Developer to Founder - Week 07_
