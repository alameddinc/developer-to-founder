...
{% embed url="https://open.spotify.com/episode/1zF90rdzKbrwEGYZxEoLzl?si=WwY_aG7nT3WnUpf2WzWT3w" %}

Bu haftanın amacı kod yazmak değil, **yazılacak kod miktarını acımasızca azaltmaktır.**

Çoğu geliştirici MVP'yi _"Minimum Version of Product"_ sanır. Oysa MVP: **"Minimum Viable Product"** (En Küçük **Yaşayabilir** Ürün) demektir.
...
Bir özelliği MVP'ye ekleyip eklemeyeceğine nasıl karar verirsin? Yazı tura atarak değil, **riske bakarak.**
...
**Neden?** Çünkü test edilen risk şuydu: _"İnsanlar sessizlik silme kalitesini beğenecek mi?"_ Login sayfası yapmak, bu riski test etmez. Sadece zaman kaybettirir.
...
* _Örnek: "Dark mode'u sildim.", "Şifremi unuttum ekranını sildim (mail atsınlar)."_
...
* _"Bunu eklemek sadece 2 saatimi alır."_ -> O 2 saatler birleşip 2 ay olur.
* _"Ama rakipte bu özellik var."_ -> Rakip 5 yıldır piyasada, sen 5 gündür.
* _"Kullanıcılar belki ister."_ -> "Belki" yok. Veri gelene kadar varsayım yok.
...
_Developer to Founder - Week 05_
